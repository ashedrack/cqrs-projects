...
//    @GetMapping("/")
//    public ResponseEntity<Account> getPatient(@RequestParam String id) {
//        Account account = queryGateway.query(
//                new FindAllUsersQuery(), Account.class
//        ).join();
//
//        if (account == null) {
...
//    }
    ...
    public List<Account> getAllUsers() throws Exception {
        FindAllUsersQuery getPatientsQuery = new FindAllUsersQuery();

        List<Account> patientQueryModel =
